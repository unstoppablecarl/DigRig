ig.module(
    ...
    EntityPlayer = ig.Entity.extend({
        ...
        gunArm: {
            animSheet: new ig.AnimationSheet('media/arm.png', 18, 8),
            currentAnim: null,
            pivot: {
                x: 1,
                y: 4
        ...
        init: function(x, y, settings) {
            ...
            this.addAnim('hurt', this.drawDamagedDuration, [12, 13]);
        ...
        update: function() {
            ...
            // handle gun arm
            if (!ig.global.wm) {
                this.gunArm.currentAnim.flip.y = this.flip;
                this.gunArm.currentAnim.angle = angleToMouse;
                if(this.flip){
                    this.gunArm.x = this.pos.x - ig.game._rscreen.x + -this.gunArm.ownerOffset.x + this.size.x - (this.gunArm.pivot.x * 2);
                } else {
            ...
            if (gunCooled && (ig.input.state('leftButton') || ig.input.state('rightButton'))) {
                ...
                if (this.charge < chargeMax && chargeIncrementReady) {
                    ...
                    this.chargeTileRadius = Math.sqrt(this.charge / Math.PI) * 0.9;
                ...
                spawnOffset = this.spawnOffset = this.projectileSpawnOffset.x + this.chargeTileRadius * ig.game.tileSize,
        ...
        draw: function() {
            ...
            if (this.drawDamaged) {
                ...
                this.gunArm.currentAnim.alpha = 0.5;
            }
